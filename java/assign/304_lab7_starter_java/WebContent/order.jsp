...
// Retrieve the shopping cart stored in session
    ...
    try
    {
        ...
        else
        {
            ...
            while (iterator.hasNext()) { 
                ...
                // Fix: Cast price as Double, not String
                double price = (Double) product.get(2);  // Correct casting
                int qty = ((Integer) product.get(3)).intValue();  // Correct casting for qty

                out.print("<td align=\"right\">" + currFormat.format(price) + "</td>");
                out.print("<td align=\"right\">" + currFormat.format(price * qty) + "</td></tr>");
                ...
                pstmt.setInt(3, qty);
                pstmt.setDouble(4, price);  // Use double for price, not String
                pstmt.executeUpdate();
            }
